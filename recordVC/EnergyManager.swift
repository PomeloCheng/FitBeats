...
class EnergyManager {
    ...
    private func startTimer() {
        ...
        if let todayDate = calendar.date(bySettingHour: 0, minute: 0, second: 0, of: currentDate) {
            ...
            if let endDate = calendar.date(bySettingHour: 23, minute: 59, second: 0, of: todayDate) {
                ...
                if timeInterval <= 0 {
                    if let tomorrowDate = calendar.date(byAdding: .day, value: 1, to: todayDate),
                       let nextEndDate = calendar.date(bySettingHour: 23, minute: 59, second: 0, of: tomorrowDate) {
